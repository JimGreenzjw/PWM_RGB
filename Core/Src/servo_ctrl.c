...
float Kp_pos_loop = 1, Ki_pos_loop = 0, Kd_pos_loop = 0;  //pid参数
float Kp_vel_loop = 0.5, Ki_vel_loop = 0.0, Kd_vel_loop = 0;
extern float goal_pos_loop, goal_vel_loop, goal_cur_loop; //目标值
float current_max = 99;
