...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
#define ENCODER_MAX 65536  // Assuming a 16-bit timer
#define MAP_MIN 0
#define MAP_MAX 1500
/* USER CODE END PM */
...
//		uint16_t new_encoder_value = __HAL_TIM_GET_COUNTER(&htim2);
//		if (cnt_encoder != new_encoder_value) {
//			cnt_encoder = new_encoder_value;
//			mapped_value = MAP_MIN
//					+ ((uint32_t) cnt_encoder * (MAP_MAX - MAP_MIN)
//							/ ENCODER_MAX);
